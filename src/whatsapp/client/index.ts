...
class Whatsapp {
    ...
    private remotePath: string =
        ...
        'https://raw.githubusercontent.com/wppconnect-team/wa-version/refs/heads/main/html/2.3000.1019160093-alpha.html';
    ...
    private async getFormattedId(id: string): Promise<string | undefined> {
        ...
        if (
            numberType === TYPE_GROUP &&
            id.length === NEW_FORMAT_GROUP_LENGTH
        ) {
